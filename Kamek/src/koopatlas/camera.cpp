...
dWorldCamera_c::dWorldCamera_c() { //originally 10 not 44
	camera3d.camPos = (Vec){0.0, 44.0, 0.0};
	...
	currentX = 416;
	currentY = -224;
	zoomLevel = STD_ZOOM - 0.4; //originally STD_ZOOM not STD_ZOOM - 0.4; 
...
int dWorldCamera_c::onCreate() {
	// Bad Code
	screen.projType = 1; //set to 0 when crash 
