...
void dKPNode_s::setupNodeExtra() {
	...
	// one-time levels
	if ((level >= 30) && (level <= 37) && (level != 33) && (level != 34) && (level != 98) && (level != 15) && (level != 25) && (level != 97) && (level != 96) && (level != 95) && (level != 94)) {
	...
	// the shop 
		...
		colour = "g3d/ambush.brres";


	else if (level == 25)
		colour = "g3d/boss.brres";
	else if (level == 15)
		colour = "g3d/boss.brres";

	else if (level == 97) //right start node 
		colour = "g3d/startR.brres";
	else if (level == 96) //down start node 
		colour = "g3d/startD.brres";
	else if (level == 95) //left start node 
		colour = "g3d/startL.brres";
	else if (level == 94) //up start node 
		colour = "g3d/startU.brres";




	else if (level == 22) 
		colour = "g3d/houseMush.brres"; //mushroom
	else if (level == 23)
		colour = "g3d/houseMushLife.brres"; //1up
	else if (level == 24)
		colour = "g3d/houseMushStar.brres"; //star
	else if (level == 33)
		colour = "g3d/houseChal.brres"; //challenge house

	else if (level == 34)
		colour = "g3d/houseMusic.brres"; //music house
